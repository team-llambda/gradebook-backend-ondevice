...
(function (EDUPoint) {
    class PXPWebServices {
        ...
        processWebRequest(functionToRun, parameters) {
        ...
        getGradebook(reportingPeriodIndex) {
            var parameter;
            ...
            return new Promise((resolve, reject) => {
                this.processWebRequest(EDUPoint.WebServiceFunction.Gradebook, parameter).then(xml => {
